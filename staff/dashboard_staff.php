                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <a href="/edata_ubmi/staff/slip_gaji.php" style="text-decoration: none;">
                                    <div class="card bg-primary bg-opacity-10 border-primary border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Slip Gaji</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Slip Gaji</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-danger bg-opacity-10 border-danger border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Input Nasabah</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Input Nasabah</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-success bg-opacity-10 border-success border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Data Nasabah</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Data Nasabah</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
