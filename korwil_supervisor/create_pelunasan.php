...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO pelunasan9 
            (bulan, tahun, kelompok, katrol,
             senin_ml, senin_mb,
             selasa_ml, selasa_mb,
             rabu_ml, rabu_mb,
             kamis_ml, kamis_mb,
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            header("Location: pelunasan.php?msg=success");
            exit();
        } else {
        ...
        <div class="card-body p-4">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="katrol" class="form-control" required>
                </div>
                    ...
                    ?>
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="<?= $day ?>_ml" class="form-control" placeholder="ML">
                                <input type="number" name="<?= $day ?>_mb" class="form-control" placeholder="MB">
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <a href="pelunasan.php" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
