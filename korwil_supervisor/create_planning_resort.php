...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO planning_resort ($columns) VALUES ($values)";
    $conn->query($sql);

    header("Location: planning_resort.php");
    exit;
}
?>
<!DOCTYPE html>
...
<body class="container my-4">
  ...
  <form method="POST">
    ...
    <div class="d-flex justify-content-between">
      ...
      <a href="planning_resort.php?tabel=<?= $tabel ?>" class="btn btn-secondary">Batal</a>
    </div>
  </form>
</body>
</html>
