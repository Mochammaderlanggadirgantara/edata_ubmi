...
$tabel = isset($_GET['tabel']) ? $_GET['tabel'] : 'pemetaan_resort';
...
<body class="boxed-size">
    ...
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">Data Pemetaan Resort</h3>
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Data Pemetaan Resort</span>
                    </li>
        ...
        <div class="container mt-4">
            ...
            <!-- HTML -->
            <div class="container mt-4">
                <a href="create_pemetaan_resort.php?tabel=<?= $tabel ?>" class="btn btn-primary mb-3">+ Tambah Data</a>
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
        <tr>
            ...
            <td>
                ...
                <a href="delete_pemetaan.php?tabel=<?= $tabel ?>&id=<?= $row['id'] ?>" 
