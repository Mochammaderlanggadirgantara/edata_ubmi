...
$result = $conn->query("
    SELECT s.id_sandi, s.kata_sandi, c.nama_cabang 
    FROM sandi s 
...
<body class="boxed-size">
    ...
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">Kelola Sandi Tabungan</h3>
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Kelola Sandi Tabungan</span>
                    </li>
        ...
        <div class="card bg-white border-0 rounded-3 mb-4">
            <div class="card-body p-4">
                <div class="button-container d-flex justify-content-between flex-wrap gap-3 mb-4">
                    ...
                    <button onclick="window.location.href='create_sandi_tabungan.php'" class="btn btn-outline-primary fs-16 py-2 px-4 ms-auto">Tambah Data</button>
                ...
                <tr>
                    <td><?= $row['id_sandi'] ?></td>
                    <td><?= htmlspecialchars($row['kata_sandi']) ?></td>
                    <td><?= $row['nama_cabang'] ?></td>
                    <td>
                        <a href="update_sandi_tabungan.php?id=<?= $row['id_sandi'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="delete_sandi.php?id=<?= $row['id_sandi'] ?>" onclick="return confirm('Hapus data ini?')" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
            <?php endwhile; ?>
                            </tbody>
