        ...
        <div class="card bg-white border-0 rounded-3 mb-4">
            <div class="card-body p-4">
                <div class="button-container d-flex justify-content-between flex-wrap gap-3 mb-4">
                    ...
                    <button onclick="window.location.href='create_cabang.php'" class="btn btn-outline-primary fs-16 py-2 px-4 ms-auto">Tambah Data</button>
                        ...
                        <table class="table align-middle w-100" id="myTables">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                    <tr>
                                        <td data-label="User ID"><?= htmlspecialchars($row['id_cabang']) ?></td>

                                        <td data-label="Jabatan" class="text-secondary"><?= htmlspecialchars($row['nama_cabang']) ?></td>

                                        <td data-label="Action">
                                            <div class="d-flex align-items-center gap-1 justify-content-center">

                                                <a href="update_cabang.php?id=<?= $row['id_cabang'] ?>" class="ps-0 border-0 bg-transparent lh-1" title="Edit">
                                                    <i class="material-symbols-outlined fs-16 text-body">edit</i>
                                                </a>
                                                <a href="delete_cabang.php?id_cabang=<?= $row['id_cabang'] ?>" class="ps-0 border-0 bg-transparent lh-1" title="Delete" onclick="return confirm('Yakin ingin menghapus data ini?');">
