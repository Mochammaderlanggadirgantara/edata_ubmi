...
// Cek apakah user memiliki jabatan 'kasir' atau 'pengawas'
$allowed_roles = ['kasir', 'pengawas'];
...
$query = "SELECT * FROM inventaris WHERE id_cabang = '$id_cabang'";
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            <div class="d-flex align-items-center gap-1 justify-content-center">
                                                ...
                                                <a href="edit_inventaris.php?id=<?= $row['id'] ?>" class="ps-0 border-0 bg-transparent lh-1" title="Edit">
                                                    <i class="material-symbols-outlined fs-16 text-body">edit</i>
                                                </a>
                                                <a href="delete_inventaris.php?id=<?= $row['id'] ?>" class="ps-0 border-0 bg-transparent lh-1" title="Delete" onclick="return confirm('Yakin ingin menghapus data ini?');">
