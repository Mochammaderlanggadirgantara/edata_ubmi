                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <a href="/edata_ubmi/kasir/inventaris.php" style="text-decoration: none;">
                                    <div class="card bg-primary bg-opacity-10 border-primary border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Data Inventaris</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Data Inventaris</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-danger bg-opacity-10 border-danger border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Tunai Babat</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Tunai Babat</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-success bg-opacity-10 border-success border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Data Service Inventaris</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Data Service Inventaris</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-info bg-opacity-10 border-info border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Input Database</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Database</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-warning bg-opacity-10 border-warning border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Sisa Saldo</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Sisa Saldo</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="card bg-secondary bg-opacity-10 border-secondary border-opacity-25 rounded-4 stats-box h-100">
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h4 class="fs-5 ms-3 mt-1 mb-0">Tabungan Kita</h4>
                                            </div>
                                            <span class="fs-6 text-muted">Tabungan Kita</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
